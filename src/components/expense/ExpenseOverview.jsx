  ...
  return (
    <div className="expense-overview">
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div className="card p-4">
          <h4 className="text-lg font-semibold mb-2">Total Expenses Amount</h4>
          <p className="text-2xl font-bold text-green-500">
            AED {calculateTotalExpenses()}
          </p>
        </div>

        <div className="card p-4">
          <h4 className="text-lg font-semibold mb-2">Average Expenses</h4>
          <p className="text-2xl font-bold text-green-500">
            AED {calculateAverageExpenses()}
          </p>
        </div>

        <div className="card p-4">
          <h4 className="text-lg font-semibold mb-2">Highest Expense</h4>
          <p className="text-2xl font-bold text-green-500">
            AED {calculateHighestExpense()}
          </p>
        </div>

        <div className="card p-4">
          <h4 className="text-lg font-semibold mb-2">Lowest Expense</h4>
          <p className="text-2xl font-bold text-green-500">
            AED {calculateLowestExpense()}
          </p>
        </div>
      </div>
